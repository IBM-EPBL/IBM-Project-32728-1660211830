...
classes = ['Marssonina leaf spot', 'Apple___Black_rot', 'Blueberry___healthy', 'Tomato___Septoria_leaf_spot', 
'Tomato___Spider_mites Two-spotted_spider_mite', 
'Tomato___Tomato_mosaic_virus', 'Marssonina leaf spot', 
'Peach___healthy', 'Pepper,_bell___healthy', 'Peach___Bacterial_spot']
